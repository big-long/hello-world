...
<script src="<%=basePath%>static/js/stock/pickoutList.js"></script>
	...
	<form method="post" action="" id="listform">
		<div class="panel admin-panel text-center">
			<div class="panel-head">
				<strong style="font-size: 30px"> 领料出库管理</strong>
			</div>
				...
				<div class="modal-body">
					...
					<div class="row">
						<div class="col-md-2 field" style="text-align: right">
							<label style="margin-top: 10px">领料出库编号：</label>
						</div>
						<div class="col-md-4 field">
							<input type="text" class="input" name="pickoutId" value="" />
						</div>
						<div class="col-md-2 field" style="text-align: right">
						...
						<div class="col-md-4 field has-feedback">
							<div class='input-group date'>
								<input type='text' class="input" name="pickoutDate" /> <span
					...
					<div class="row">
						<div class="col-md-2 field" style="text-align: right">
							<label style="margin-top: 10px">领料编号：</label>
						</div>
						<div class="col-md-4 field">
							<select class="input" name="plId">
								<option></option>
								<c:forEach items="${pickLists }" var="pickList">
									<option value="${pickList.plId }">${pickList.plId }</option>
								</c:forEach>
							</select>
						</div>
						<!-- <div class="col-md-2 field" style="text-align: right">
					...
					<div class="row">
						<div class="col-md-2 field" style="text-align: right">
							<label style="margin-top: 10px">材料名称：</label>
						</div>
						<div class="col-md-4 field">
						...
						<div class="col-md-4 field ">
							<div class='input-group date'>
								<input type='text' class="input" name="provider" /> 
							</div>
						</div>
					</div>
					<div class="row">
