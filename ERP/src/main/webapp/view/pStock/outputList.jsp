...
<script src="<%=basePath%>static/js/stock/outPutList.js"></script>
...
<body>
	<form method="post" action="" id="listform">
		<div class="panel admin-panel text-center">
			<div class="panel-head">
				<strong style="font-size: 30px"> 销售出库管理</strong>
			</div>
			...
			<div class="padding border-botton">
				<ul class="search" style="padding-left: 10px;">
					...
					<li><button type="button" name="add"
							...
							data-target="#addOutput" data-toggle="modal">添加新出库单</button></li>
	...
	<div class="modal fade bs-example-modal-lg" id="addOutput"
