...
<script src="<%=basePath%>static/js/stock/gStockList.js"></script>
	...
	<form method="post" action="" id="listform">
		<div class="panel admin-panel text-center">
			<div class="panel-head">
				<strong style="font-size: 30px"> 商品入库管理</strong>
			</div>
				...
				<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-4 field">
							<input type="text" class="input" name="gStockId" value="" />
						</div>
						<div class="col-md-2 field" style="text-align: right">
							<label style="margin-top: 10px">入库日期：</label>
						</div>
						<div class="col-md-4 field">
							<input type="text" class="input" name="stockDate" value="" />
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-md-4 field">
							<select class="input" name="purchaseId">
								<option></option>
