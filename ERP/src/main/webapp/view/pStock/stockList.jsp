...
<script src="<%=basePath%>static/js/stock/stockList.js"></script>
	...
	<form method="post" action="" id="listform">
		<div class="panel admin-panel text-center">
			<div class="panel-head">
				<strong style="font-size: 30px"> 产品入库管理</strong>
			</div>
			...
			<div class="padding border-botton">
				<ul class="search" style="padding-left: 10px;">
					...
					<li><button type="button" name="add"
							...
							data-target="#modal" data-toggle="modal">添加新的入库单</button></li>
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header" style="text-align: center">
					...
					<h4 class="modal-title" id="myModalLabel">添加新的入库单</h4>
				</div>
				...
				<div class="modal-body">
					...
					<div class="row">
						<div class="col-md-2 field" style="text-align: right">
							<label style="margin-top: 10px">入库编号：</label>
						</div>
						<div class="col-md-4 field">
							<input type="text" class="input" name="inbillId" value="" />
						</div>
						<div class="col-md-2 field" style="text-align: right">
							<label style="margin-top: 10px">入库日期：</label>
						</div>
						<div class="col-md-4 field">
							<input type="text" class="input" name="inbillDate" value="" />
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-md-4 field">
							<select class="input" name="productionId">
								<option></option>
								<c:forEach items="${regists }" var="regist">
									<option value="${regist.productionId }">${regist.productionId }</option>
								</c:forEach>
							</select>
						</div>
					...
					<div class="row">
						...
						<div class="col-md-4 field has-feedback">
							<div class='input-group date'>
								<input type='text' class="input" name="provider" /> <span
					...
					<div class="row">
						...
						<div class="col-md-4 field">
							<input type="text" class="input" name="inbillNumber" value="" />
						</div>
					</div>
					<div class="row">
						<div class="col-md-2 field" style="text-align: right">
